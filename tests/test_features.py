...
def test_packet_flow_key(mock_packets):
    ...
    """
    tcp_fwd_1, tcp_fwd_2, tcp_rev_1, tcp_rev_2, icmp_packet, udp_packet = mock_packets  # Use destructured packets
    ...
    get_packet_flow_key(udp_packet, PacketDirection.REVERSE)
